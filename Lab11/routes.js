...
if (req.url === "/") {
  ...
  res.write(
    '<form action="AgregarPelicula" method="POST"><input type="text" name="nombre"><br><br><input type="submit" value="Agregar pelicula a la lista"></form>'
  );
  res.write("</html>");
  ...
  res.write("<html>");
  res.write(
    "<head><meta charset='UTF-8'><title>Agregar Pelicula</title></head>"
  );
  ...
  res.write(
    "<body><h1>Series</h1><ul><li>You Me Her</li><li>Avatar</li><li>How I Met Your Mother</li></ul></body>"
  );
  res.write("</html>");
  ...
  res.write(
    "<body><h1>Musica</h1><ul><li>Yegua - Los Babasonicos</li><li>Scrawny - Wallows</li><li>Odiame - Efecto Mandarina</li></ul></body>"
  );
  res.write("</html>");
} else {
  res.statusCode = 404;
